            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group"> 
                          <label id="a"for="">ชื่อ-สกุลมารดา&nbsp;&nbsp;&nbsp;&nbsp; </label> <?php echo $row["mom"];?>
        ...
        <div class="card">
          <div class="card-body">
            <img
              ...
              alt="..."
            />
            <h5 class="card-title" style="font-family: Mali, cursive">
        ...
        <div class="card">
          <div class="card-body">
            <img
              ...
              width="20px"
            />
            <h5 class="card-title"style="font-family: Mali, cursive">การให้นมทารก</h5>
