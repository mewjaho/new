  ...
  <nav
    ...
    <div class="navigation mt-5">
      <ul>
        ...
        <li class="list" >
          <a href="/mom/page/datam.php?HN=<?php echo $row["HN"];?>">
            <span class="icon"><ion-icon name="server-outline"></ion-icon>
              
            </span>
            <span class="title">ข้อมูล</span>
          </a>
        </li>
        ...
        <li class="list" id="out">
          <a href="/mom/page/notify.php?HN=<?php echo $row["HN"];?>">
            ...
            <span class="title">รายงานปัญหา</span>
          </a>
        </li>
        <li class="list">
...
" >
  ...
  <?php foreach ($result as $row) {?>
    <tr>
      ...
      <td><button type="submit" class="btn btn-danger"   onclick="return confirm('คุณต้องการลบข้อมูลทั้งหมดหรือไม่')">ลบ</td>
